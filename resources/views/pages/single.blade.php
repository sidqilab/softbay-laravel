...
@section('content')
 ...
 <nav>
  <ol class="breadcrumb bg-transparent pl-0">
    ...
    <li class="breadcrumb-item" aria-current="page">Single Product</li>
  </ol>
</nav>
</div>
...
<section class="single-product">
  <div class="container">
    <div class="row">
      <div class="col-lg-5">
        <figure class="figure">
          <img src="images/single/1.png" class="figure-img img-fluid">
          <figcaption class="figure-caption product-thumbnail-container d-flex justify-content-between">
            <a href="">
              <img src="images/single/thumbnail/1.png" >
            </a>
               <a href="">
              <img src="images/single/thumbnail/2.png" >
            </a>
               <a href="">
              <img src="images/single/thumbnail/3.png" >
            </a>
               <a href="">
              <img src="images/single/thumbnail/4.png" >
            </a>
          </figcaption>
        </figure>
      </div>
      ...
      <div class="col-lg-3">
        ...
        <button type="button" class="btn btn-sm" style="background-color: #EAEAEF; color:white;"><i class="fas fa-minus-circle"></i>
        </button>
        <span class="mx-2">20</span>
         <button type="button" class="btn btn-sm" style="background-color: #1ABC9C; color:white;"><i class="fas fa-plus-circle"></i>
        </button>
        ...
        <div class="row">
          <div class="col-3">
            <img src="images/single/2.png" alt="">
          </div>
          <div class="col">
            <h4>Anne Mortgery</h4>
    ...
    <div class="row">
      <div class="col-lg-9">
        ...
        <div class="tab-pane fade show active product-review" id="description" role="tabpanel" aria-labelledby="description-tab">
          <p>
            Payday is finally here and you’ve got some extra cash to help you  stock up your summer
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In nec felis metus. Vivamus eu urna
      ...
      <div class="tab-pane fade product-review" id="review" role="tabpanel" aria-labelledby="review-tab">
        <div class="row">
          <div class="col-1 d-none d-md-block">
            <img src="images/single/review/1.png" >
          </div>
          <div class="col">
            <h5>Joe Mackenzie</h5>
            <p>
              Produknya bagus dan juga rapih cocok untuk kulit
            </p>
          </div>
        </div>
         <div class="row">
          <div class="col-1 d-none d-md-block">
            <img src="images/single/review/2.png" >
          </div>
          <div class="col">
            <h5>Brian Smith</h5>
            <p>
              Kerudungnya tidak membuat Kepala menjadi panas
            </p>
          </div>
        </div>
         <div class="row">
          <div class="col-1 d-none d-md-block">
            <img src="images/single/review/3.png" >
          </div>
          <div class="col">
            <h5>Lynda Lin</h5>
            <p>
  ...
  <div class="container">
   <div class="row mb-3">
          <div class="col">
            ...
            <p>
              Pakaian pelengkap produk di atas
            </p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-4">
            <figure class="figure">
              <img src="images/single/similar/1.png" class="figure-img img-fluid">
             ...
             <div class="col-sm-4">
            <figure class="figure">
              <img src="images/single/similar/2.png" class="figure-img img-fluid">
              <figcaption class="figure-caption">
                <div class="row">
                  <div class="col">
                    <h4 style="font-size: 22px;">
             ...
             <div class="col-sm-4">
            <figure class="figure">
              <img src="images/single/similar/3.png" class="figure-img img-fluid">
              <figcaption class="figure-caption">
                <div class="row">
                  <div class="col">
                    <h4 style="font-size: 22px;">
